  ...
  return (
    <div className="min-h-screen bg-[#0e1a40] text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center px-6 md:px-10 pb-16 pt-10 md:pt-16">
        ...
        <section className="mx-auto flex w-full max-w-6xl flex-col gap-10 md:gap-12 py-6 md:py-10">
          <div className="grid gap-10 lg:gap-14 lg:grid-cols-[minmax(0,1.6fr)_minmax(0,2.2fr)]">
            <section className="space-y-6">
              <h2 className="text-base md:text-lg font-semibold tracking-wide text-slate-100">
                Education
              </h2>

              <div className="rounded-2xl bg-[#222f5b]/90 p-5 md:p-6 shadow-lg shadow-black/40">
                <div className="flex items-start gap-4">
                  <div className="relative mt-1 h-10 w-10 md:h-12 md:w-12 rounded-full bg-black flex items-center justify-center overflow-hidden shrink-0">
                    <Image
                  ...
                  <div className="space-y-1 text-sm">
                    <p className="text-xs md:text-sm font-semibold uppercase tracking-wide text-[#946b2d]">
                    ...
                    <p className="text-[0.7rem] md:text-xs text-slate-300">
            ...
            <section className="space-y-6">
              ...
              <div className="relative">
                <div className="absolute left-[12px] sm:left-[14px] top-2 bottom-2 w-px bg-black/50 lg:left-4" />
                ...
                <div className="space-y-6 md:space-y-8">
                  <article className="relative flex gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 rounded-2xl bg-[#222f5b]/90 p-4 md:p-5 shadow-lg shadow-black/40">
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[0.7rem] md:text-xs font-medium text-[#946b2d]">
                        ...
                        <p className="mt-1 text-[0.7rem] md:text-xs text-slate-300 sm:mt-0 text-right whitespace-nowrap">
                          12/2024 – Present
                        </p>
                      </div>

                      <ul className="mt-3 space-y-2 text-xs md:text-sm text-slate-100">
